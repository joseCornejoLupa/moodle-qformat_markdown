...
$string['pluginname_help'] = 'Importa o exporta preguntas escritas en una sintaxis simple de Markdown: cada pregunta es un encabezado "## " seguido de opciones "- [ ]" / "- [x]" (opción múltiple o verdadero/falso), líneas "= " (respuesta corta), o líneas "=# " (numérica). Una línea opcional "> " agrega retroalimentación general, y una línea opcional "@ valor" define la nota propia de esa pregunta. Un bloque opcional "---" al inicio del archivo puede definir "category" y/o "defaultmark" para todas las preguntas. La exportación solo admite preguntas de opción múltiple, verdadero/falso, respuesta corta y numérica.';
